...
Thyristor::Thyristor()
{
  ...
  Lines.append(Line(  0,-30,  0, 30,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -9,  6,  9,  6,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -9, -6,  9, -6,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  0,  6, -9, -6,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  0,  6,  9, -6,QPen(Qt::darkBlue,2)));

  Lines.append(Line( -9, 10, -5,  6,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-20, 10, -9, 10,QPen(Qt::darkBlue,2)));

  Ports.append(Port(  0,-30));
  Ports.append(Port(  0, 30));
  Ports.append(Port(-20, 10));
