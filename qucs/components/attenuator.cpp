...
Attenuator::Attenuator()
{
  ...
  Lines.append(Line( -4, -6, -4,  6,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -4, -6,  4, -6,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  4, -6,  4,  6,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -4,  6,  4,  6,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  0,-11,  0, -6,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  0,  6,  0, 11,QPen(Qt::darkBlue,2)));
  ...
  Props.append(Property("L", "10 dB", true,
