...
Ampere_noise::Ampere_noise()
{
  ...
  Lines.append(Line(-12,  1,  1,-12,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-10,  6, -7,  3,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  3, -7,  6,-10,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -7, 10, -2,  5,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  7, -4, 10, -7,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -1, 12, 12, -1,QPen(Qt::darkBlue,2)));
  ...
  Props.append(Property("i", "1e-6", true,
