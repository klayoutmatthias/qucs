...
QString comp_1bit::vhdlCode( int )
{
  ...
  QString X    = Ports.at(0).getConnection()->Name;
  QString Y    = Ports.at(1).getConnection()->Name;
  QString L    = Ports.at(2).getConnection()->Name;
  QString G    = Ports.at(3).getConnection()->Name;
