...
MScoupled::MScoupled()
{
  ...
  Lines.append(Line(-30,-12,-16,-12,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-30,-30,-30,-12,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 20,-12, 30,-12,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 30,-30, 30,-12,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-11,-20, 25,-20,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-21, -4, 15, -4,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-11,-20,-21, -4,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 25,-20, 15, -4,QPen(Qt::darkBlue,2)));

  Lines.append(Line(-30, 12,-20, 12,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-30, 30,-30, 12,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 16, 12, 30, 12,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 30, 30, 30, 12,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-15,  4, 21,  4,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-25, 20, 11, 20,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-15,  4,-25, 20,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 21,  4, 11, 20,QPen(Qt::darkBlue,2)));
