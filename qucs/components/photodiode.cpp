...
photodiode::photodiode()
{
  ...
  Props.append (Property ("N", "1.35", false,
    QObject::tr ("photodiode emission coefficient")));
  Props.append (Property ("Rseries", "1e-3", false,
    QObject::tr ("series lead resistance")
    +" ("+QObject::tr ("Ohm")+")"));
  Props.append (Property ("Is", "0.34e-12", false,
  ...
  Props.append (Property ("Ibv", "1e-3", false,
    ...
    +" ("+QObject::tr ("A")+")"));
  Props.append (Property ("Vj", "0.7", false,
    QObject::tr ("junction potential")
    +" ("+QObject::tr ("V")+")"));
  Props.append (Property ("Cj0", "60e-12", false,
  ...
  Props.append (Property ("Tt", "10e-9", false,
    QObject::tr ("transit time")
    +" ("+QObject::tr ("s")+")"));
  Props.append (Property ("Xti", "3.0", false,
    QObject::tr ("saturation current temperature exponent")));
  Props.append (Property ("Eg", "1.16", false,
    QObject::tr ("energy gap")
    +" ("+QObject::tr ("eV")+")"));
  Props.append (Property ("Responsivity", "0.5", false,
    QObject::tr ("responsivity")
    +" ("+QObject::tr ("A/W")+")"));
  Props.append (Property ("Rsh", "5e8", false,
    QObject::tr ("shunt resistance")
    +" ("+QObject::tr ("Ohm")+")"));
  Props.append (Property ("QEpercent", "80", false,
    QObject::tr ("quantum efficiency")
    +" ("+QObject::tr ("%")+")"));
  Props.append (Property ("Lambda", "900", false,
...
{
  Arcs.append(Arc(-12,-12, 24, 24, 0, 16*360,QPen(Qt::red,2)));
  ...
  Lines.append(Line( -6,  0,  6,  9,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  0, 12,  0,  30,QPen(Qt::green,2)));
