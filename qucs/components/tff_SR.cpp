...
void tff_SR::createSymbol()
{
  ...
  Lines.append(Line( -30, 10,-20, 20,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -30, 30,-20, 20,QPen(Qt::darkBlue,2)));
  ...
  Texts.append(Text(-25,-32, "T", Qt::darkBlue, 12.0));
  ...
  Ports.append(Port(-50,-20));  // T
  Ports.append(Port(-50, 20));  // CLK
...
QString tff_SR::vhdlCode( int )
{
  ...
  QString T     = Ports.at(1).getConnection()->Name;
  QString CLK   = Ports.at(2).getConnection()->Name;
  QString R     = Ports.at(3).getConnection()->Name;
  QString QB    = Ports.at(4).getConnection()->Name;
  QString Q     = Ports.at(5).getConnection()->Name;
