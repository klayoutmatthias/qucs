...
Volt_noise::Volt_noise()
{
  ...
  Lines.append(Line(-10,  6,  6,-10,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -7, 10, 10, -7,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -2, 12, 12, -2,QPen(Qt::darkBlue,2)));
  ...
  Props.append(Property("u", "1e-6", true,
