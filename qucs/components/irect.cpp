...
iRect::iRect()
{
  ...
  Lines.append(Line( 19,  5, 19,  7,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 13,  7, 19,  7,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 13,  7, 13, 11,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 13, 11, 19, 11,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 19, 11, 19, 15,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 13, 15, 19, 15,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 13, 15, 13, 17,QPen(Qt::darkBlue,2)));
  ...
  Props.append(Property("I", "1 mA", true,
		QObject::tr("current at high pulse")));
  Props.append(Property("TH", "1 ms", true,
		QObject::tr("duration of high pulses")));
  Props.append(Property("TL", "1 ms", true,
  ...
  Props.append(Property("Td", "0 ns", false,
