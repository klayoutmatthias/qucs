...
iExp::iExp()
{
  ...
  Lines.append(Line( 30,  0, 12,  0,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -7,  0,  7,  0,QPen(Qt::darkBlue,3)));
  Lines.append(Line(  6,  0,  0, -4,QPen(Qt::darkBlue,3)));
  Lines.append(Line(  6,  0,  0,  4,QPen(Qt::darkBlue,3)));

  // write 'Exp' beside current source symbol
  Lines.append(Line( 13,  7, 13, 10,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 13,  7, 21, 7,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 17,  7, 17, 10,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 21,  7, 21, 10,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 13,  13, 17, 17,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 17,  13, 13, 17,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 17,  20, 11, 20,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 17,  20, 17, 23,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 13,  20, 13, 23,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 17,  23, 13, 23,QPen(Qt::darkBlue,2)));
  ...
  Props.append(Property("I2", "1 A", true,
