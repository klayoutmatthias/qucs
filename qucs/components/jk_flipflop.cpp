...
JK_FlipFlop::JK_FlipFlop()
{
  ...
  Lines.append(Line(-20,-30, 20,-30,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-20, 30, 20, 30,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-20,-30,-20, 30,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 20,-30, 20, 30,QPen(Qt::darkBlue,2)));
  ...
  Lines.append(Line( 30,-20, 20,-20,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 30, 20, 20, 20,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-30,  0,-20,  0,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  0,-30,  0,-40,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  0, 30,  0, 40,QPen(Qt::darkBlue,2)));

  Texts.append(Text( -4,-29, "S", Qt::darkBlue,  9.0));
  Texts.append(Text( -4, 14, "R", Qt::darkBlue,  9.0));
  Texts.append(Text(-18,-31, "J", Qt::darkBlue, 12.0));
  Texts.append(Text(-18,  8, "K", Qt::darkBlue, 12.0));
  Texts.append(Text(  6,-31, "Q", Qt::darkBlue, 12.0));
  Texts.append(Text(  6,  8, "Q", Qt::darkBlue, 12.0));
  Texts.last().over=true;
  Lines.append(Line(-20, -4,-12,  0,QPen(Qt::darkBlue,0)));
  Lines.append(Line(-20,  4,-12,  0,QPen(Qt::darkBlue,0)));

  Ports.append(Port(-30,-20));  // J
  Ports.append(Port(-30, 20));  // K
  Ports.append(Port( 30,-20));  // Q
  Ports.append(Port( 30, 20));  // nQ
  Ports.append(Port(-30,  0));  // Clock
  Ports.append(Port(  0,-40));  // set
  Ports.append(Port(  0, 40));  // reset
