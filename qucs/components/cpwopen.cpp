...
CPWopen::CPWopen()
{
  ...
  Lines.append(Line(-25,-13, 11,-13,QPen(Qt::darkBlue,2)));
  Lines.append(Line(-25, 13, -5, 13,QPen(Qt::darkBlue,2)));
  Lines.append(Line( 11,-13, -5, 13,QPen(Qt::darkBlue,2)));
  ...
  Lines.append(Line(  8,-21, 15,-14,QPen(Qt::darkBlue,2)));
  
  Lines.append(Line( 10,-11, 15, -6,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  7, -6, 15,  2,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  4, -1, 15, 10,QPen(Qt::darkBlue,2)));
  Lines.append(Line(  1,  4, 15, 18,QPen(Qt::darkBlue,2)));
  ...
  Lines.append(Line( -6, 13,  2, 21,QPen(Qt::darkBlue,2)));
  Lines.append(Line( -2,  9, 10, 21,QPen(Qt::darkBlue,2)));
  ...
  Props.append(Property("G", "5 mm", true,
